;(function () {
    ...
    TYRANO.kag.tag.text = $.extend(true, {}, _text, {
        showMessage: function (message_str, pm, isVertical) {
            ...
            _text.showMessage.apply(this, arguments)
        },
    })
        ...
        start: function (pm) {
            ...
            if (this.kag.config.autoRecordLabel == "true") {
                ...
                if (this.kag.stat.buff_label_name != "") {
                    ...
                    if (TYRANO.kag.variable.sf._ars_ex.is_unreadskip === true && TYRANO.kag.stat.is_skip && TYRANO.kag.variable.sf.record[sf_buff] === 0) {
                        //未読のまま
                    } else {
